...
| 7 | **Katalog vozila** — padajući meni za marku/model umesto slobodnog kucanja. `core/js/catalog.js`, offline embedded, 38 marki ~550 modela. | Nikola + Milan | core (data) | Garage + Driver | ✅ URAĐENO (Driver v1.7.0) — Garage quickVehicle čeka full form |
