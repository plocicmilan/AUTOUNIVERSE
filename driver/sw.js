/* DRIVER TOOLBOX — service worker (GATE A: airplane mode mora raditi)
   Strategija: cache-first. Sve bundled, nikad CDN.                    */
"use strict";

var CACHE = "driver-toolbox-v1.42.0"; // podigni verziju pri svakom deploy-u

var PRECACHE = [
  "index.html",
  "css/app.css",
  "js/app.js",
  "config/driver_v1.json",
  "manifest.json",
  "../core/css/core.css",
  "../core/js/platform.js",
  "../core/js/models.js",
  "../core/js/store.web.js",
  "../core/js/store.native.js",
  "../core/js/store.js",
  "../core/js/photos.js",
  "../core/js/share.js",
  "../core/js/pdf.js",
  ...
  "../core/js/aucore.js",
  "../core/js/autopijaca.js",
  "../core/js/catalog.js",
  "../core/js/tags.js",
  "../core/js/trust.js",
  "../core/js/trust_card.js",
  "../core/js/lib/qr.min.js",
